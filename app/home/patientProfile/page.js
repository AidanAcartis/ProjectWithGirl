...
import Agenda from '../../components/NewFolderComponent/dashboard/SimpleUtilisateur/AGENDA/agenda.js';
import EvaluationForm from '../../components/NewFolderComponent/dashboard/SimpleUtilisateur/activity.js';
import ServiceStatus from '../../components/NewFolderComponent/dashboard/Service_Security/statusService.js';
...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    if (['status', 'Activités', 'contacts', 'agenda'].includes(currentPath)) {
  ...
  return (
    ...
    <Layout>
      ...
      {activeTab === 'Activités' && (
        <div>
          <Card>
            <h2 className="font-bold text-3xl mb-2">Évaluation</h2>
             <EvaluationForm />
          </Card>
        </div>
      )}
